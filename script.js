...
const langDict = {
    'th': {
        ...
        homeFooterNoteHtml: '<p>(แอพกำลังพัฒนา ควรกดรีเซ็ตแอพใหม่ทุกวัน เพื่อได้รับการอัพเดต)</p>',
    ...
    'en': {
        ...
        homeFooterNoteHtml: '<p>(The app is in development, please reset the app daily to receive updates.)</p>',
...
// Add event listeners for rainbow button lit effect
document.addEventListener('DOMContentLoaded', () => {
    const rainbowButtons = document.querySelectorAll('.btn-rainbow');
    rainbowButtons.forEach(btn => {
        let litTimeout = null;
